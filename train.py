...
# Create a list of currently model architecture candidates from torchvision.models
arch_supported = ['alexnet','densenet121','densenet161','densenet169','densenet201','mnasnet0_5', 'mnasnet0_75','mnasnet1_0',
                'mnasnet1_3', 'mobilenet_v2', 'vgg11', 'vgg11_bn', 'vgg13', 'vgg13_bn', 'vgg16', 'vgg16_bn', 'vgg19', 'vgg19_bn']
